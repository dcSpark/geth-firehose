...
import (
	...
	firehose "github.com/ethereum/go-ethereum/firehose"
...
func (m *MockGenesisContract) CommitState(arg0 *clerk.EventRecordWithTime, arg1 *state.StateDB, arg2 *types.Header, arg3 statefull.ChainContext, arg4 *firehose.Context) (uint64, error) {
	m.ctrl.T.Helper()
